...
var LocationMarker = function(data) {
    ...
    // event listener mouseover and out
...
var ViewModel = function() {
    ...
    // each location and their markers added
...
//when clicked, the infoWindow is populated with crimes based on the marker position
function populateInfoWindow(marker, street, city, infowindow) {
    ...
    if (infowindow.marker != marker) {
        ...
        //compute the streetview position, the heading, and get a panorama
